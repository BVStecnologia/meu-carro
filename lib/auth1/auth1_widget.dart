...
class _Auth1WidgetState extends State<Auth1Widget>
  ...
  void initState() {
    ...
    _model.passwordConfirmcriarTextController ??= TextEditingController();
    _model.passwordConfirmcriarFocusNode ??= FocusNode();
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: TextFormField(
                                                    controller: _model
                                                        .passwordConfirmcriarTextController,
                                                    focusNode: _model
                                                        .passwordConfirmcriarFocusNode,
                                                    autofocus: false,
                                                    autofillHints: [
                                                      AutofillHints.password
                                                    ],
                                                    obscureText: !_model
                                                        .passwordConfirmcriarVisibility,
                                                    decoration: InputDecoration(
                                                      labelText:
                                                          'Confirme a  Senha',
                                                      labelStyle:
                                                      ...
                                                      suffixIcon: InkWell(
                                                        ...
                                                        focusNode: FocusNode(
                                                            skipTraversal:
                                                                true),
                                                        child: Icon(
                                                          _model.passwordConfirmcriarVisibility
                                                              ? Icons
                                                                  .visibility_outlined
                                                              : Icons
                                                                  .visibility_off_outlined,
                                                              ...
                                                              onPressed:
                                                                ...
                                                                ScaffoldMessenger.of(
                                                                  ...
                                                                  SnackBar(
                                                                    content:
                                                                        Text(
                                                                      'Login conta criada com sucesso!',
                                                                      style:
                                                                          TextStyle(
                                                                        color: FlutterFlowTheme.of(context)
                                                                            .primaryText,
